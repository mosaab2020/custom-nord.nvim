...
theme.loadEditor = function()
  ...
  local editor = {
    ...
    PmenuSbar = { fg = nord.nord4_gui, bg = nord.nord10_gui },
    PmenuThumb = { fg = nord.nord0_gui, bg = nord.nord0_gui },
...
theme.loadTreeSitter = function()
  ...
  local treesitter = {
    ...
    ["@constant.html"] = { fg = nord.nord9_gui },
    ["@markup.link.label.html"] = { fg = nord.nord5_gui },
